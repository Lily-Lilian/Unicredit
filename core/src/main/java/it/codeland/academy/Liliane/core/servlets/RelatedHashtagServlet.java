...
public class RelatedHashtagServlet extends SlingSafeMethodsServlet {
    ...
    protected void doGet(final SlingHttpServletRequest req, final SlingHttpServletResponse resp) throws ServletException, IOException {
                ...
                try {      
                    ...
                    String queryText = "SELECT * FROM [cq:PageContent] AS nodes WHERE ISDESCENDANTNODE ([/content/ucs-exercise-liliane/magazine]) AND nodes.[cq:tags] LIKE '%"+tag+"' ORDER BY [jcr:created] ASC";
