...
import it.codeland.academy.Liliane.core.utils.Rendition;


@Model(adaptables = {SlingHttpServletRequest.class, Resource.class},
        defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)

public class HandleRendition {
    ...
    public void init() {
    	...
    	if(StringUtils.isNotBlank(fileReference)) {
			LOG.info("\n\n##### INFO  ##### IMAGE RENDITION CLASS PART1  \n\n");
	...
	public static Object getAllNamesTransform() {
		return null;
	}
