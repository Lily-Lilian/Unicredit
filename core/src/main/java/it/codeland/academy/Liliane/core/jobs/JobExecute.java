package it.codeland.academy.Liliane.core.jobs;
...
@Component( service= JobExecutor.class,
        ...
        property = {
                ...
                JobExecutor.PROPERTY_TOPICS + "=liliane/job/topic"
        })
public class JobExecute implements JobExecutor{
    ...
    public JobExecutionResult process(final Job job, JobExecutionContext context){
        ...
        try {
            ...
            Resource resource = resolver.getResource("/content/dam/ucs-exercise-liliane/Article.csv");
            if(resource == null){
           ...
           int i =0;
            ...
            Page magazinePage = pageManager.getPage("/content/ucs-exercise-liliane/magazine/");
                ...
                if(row.length == 6){
                    ...
                    if(pageManager.getPage("/content/ucs-exercise-liliane/magazine/" + articleData.pageName + "/") == null) {
                        ...
                        articleData.abstractText = row[FIELD_INDEX_ABSTRACT];
                         DateTime dt = new DateTime(row[FIELD_INDEX_DATE]);
