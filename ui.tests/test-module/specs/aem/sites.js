...
const AEM_SAMPLE_PAGE_PARENT = "/content/ucs-exercise-liliane/us";
...
describe("AEM Sites Console", () => {
  ...
  describe("Page Properties form", () => {
    ...
    it("should let user modify the title of a page", () => {
      ...
      // Change page title
      originalTitle = browser.AEMSitesSetPageTitle(
        AEM_SAMPLE_PAGE_PARENT,
        AEM_SAMPLE_PAGE_ID,
        modifiedTitle
      );
      ...
      browser.url(
        `${path.posix.join(AEM_SAMPLE_PAGE_PARENT, AEM_SAMPLE_PAGE_ID)}.html`
      );
